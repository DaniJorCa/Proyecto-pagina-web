...
if(empty($deseos) || !is_array($deseos)){
    echo '<img class="my-4" src="img/genioLampara.png" style="height: 300px; width: 270px;"></img>';
...
<?php
    ...
    echo '<td><a href="index.php?view=_add_cart&id=' . $articulo[0]['id_articulo'] . '" class="btn btn-add-cart"><i class="fa-solid fa-cart-shopping cart-card"></i>Comprar ' .$articulo[0]['precio'] - ($articulo[0]['precio'] * 0.1). '€</a></td>';
    echo "</tr>";   
    }
}
?>
